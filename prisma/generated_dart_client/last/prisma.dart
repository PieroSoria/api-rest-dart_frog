// ignore_for_file: non_constant_identifier_names, lines_longer_than_80_chars, unnecessary_library_directive
...
class UserGroupByOutputType {
  ...
  factory UserGroupByOutputType.fromJson(Map<dynamic,dynamic> json) => UserGroupByOutputType(
        id: json['id'] as int?,
        name: json['name'] as String?,
        lastname: json['lastname'] as String?,
        username: json['username'] as String?,
